...
namespace OurLittleUniverse.Migrations.Sqlite
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentUrl = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    AttachmentMimeType = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    AttachmentSizeBytes = table.Column<long>(type: "INTEGER", nullable: true),
                    EncryptionMode = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    ...
                    KeyId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveTheme = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    LanguageMode = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    ...
                    PartnerActivityEmailsEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasscodeHash = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    VisibilityLevel = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    PrivateNote = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverUrl = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    License = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Attribution = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    IsFavorite = table.Column<bool>(type: "INTEGER", nullable: false),
                    FavoritedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    FavoritedByUserId = table.Column<Guid>(type: "TEXT", nullable: true),
                    VisibilityLevel = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
